...
;(function($) {
  $.fn.customselect = function(method, value) {
    ...
    // Default Options
    var $options  = {
      "csclass"         : "select-controll-app",  // Class to match
      ...
      "emptytext"       : "Nenhum Resultado Encontrado",               // Change empty option text to a set value
        ...
        init: function() {
          ...
          var setup = {
            ...
            subcontainer: function() {
              ...
              // Input Box
              var input   = $("<input type='input' placeholder='Pesquisa'/>").appendTo(subcont);
