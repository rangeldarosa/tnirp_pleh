  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered table-vcenter table-list">
      <thead>
            ...
            <th class="text-center">Senha <span class="glyphicon glyphicon-sort"></span></th>
      ...
      <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><a title="Editar Usuário" href="<?php echo URL; ?>usuario/editarUsuario/<?php echo URL; ?>usuario/editarUsuario/<?php echo $usuario->CD_USUARIO;?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
